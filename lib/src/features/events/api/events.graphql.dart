...
class Query$CalendarItems {
  Query$CalendarItems({required this.events, required this.$__typename});
...
extension UtilityExtension$Query$CalendarItems on Query$CalendarItems {
  CopyWith$Query$CalendarItems<Query$CalendarItems> get copyWith =>
      CopyWith$Query$CalendarItems(this, (i) => i);
}

abstract class CopyWith$Query$CalendarItems<TRes> {
  factory CopyWith$Query$CalendarItems(Query$CalendarItems instance,
  ...
  TRes call({List<Query$CalendarItems$events?>? events, String? $__typename});
  TRes events(
...
class _CopyWithImpl$Query$CalendarItems<TRes>
  ...
  _CopyWithImpl$Query$CalendarItems(this._instance, this._then);
  ...
  TRes events(
      ...
      call(
          events: _fn(_instance.events.map((e) => e == null
              ? null
              : CopyWith$Query$CalendarItems$events(e, (i) => i))).toList());
}
...
class _CopyWithStubImpl$Query$CalendarItems<TRes>
  ...
  call({List<Query$CalendarItems$events?>? events, String? $__typename}) =>
      _res;
  events(_fn) => _res;
}
...
class FetchMoreOptions$Query$CalendarItems extends graphql.FetchMoreOptions {
  FetchMoreOptions$Query$CalendarItems(
      ...
      : super(
            updateQuery: updateQuery, document: documentNodeQueryCalendarItems);
}
...
extension ClientExtension$Query$CalendarItems on graphql.GraphQLClient {
  ...
  void writeQuery$CalendarItems(
          {required Query$CalendarItems data, bool broadcast = true}) =>
      this.writeQuery(
          graphql.Request(
              operation:
...
class Query$CalendarItems$events {
  ...
  int get hashCode {
    ...
    final l$$__typename = $__typename;
    return Object.hashAll(
        [l$id, l$title, l$start_time, l$end_time, l$$__typename]);
  }
...
extension UtilityExtension$Query$CalendarItems$events
  ...
  CopyWith$Query$CalendarItems$events<Query$CalendarItems$events>
      get copyWith => CopyWith$Query$CalendarItems$events(this, (i) => i);
}
...
class _CopyWithImpl$Query$CalendarItems$events<TRes>
  ...
  _CopyWithImpl$Query$CalendarItems$events(this._instance, this._then);
