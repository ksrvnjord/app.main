...
class _CreateFormFillerState extends ConsumerState<CreateFormFiller> {
  ...
  void initState() {
    ...
    // Optional: Listen to controller changes and update model accordingly
  ...
  void didUpdateWidget(CreateFormFiller oldWidget) {
    ...
    // If the filler object changes externally, update controller texts to stay in sync
    ...
    return Row(
      children: [
        Expanded(
          child: Column(
            children: [
              // Title TextField - centered and bold
              Row(
                children: [
                  Expanded(
                    child: TextFormField(
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                      onPressed: () => widget.deleteFiller(widget.filler.index),
              ...
              // Body TextField - left aligned and normal weight
              TextFormField(
                validator: (value) => (value == null || value.isEmpty)
                ...
                decoration: const InputDecoration(
                  hintText: 'Ruime voor uitleg, prijzen, disclaimers etc...',
                  border: InputBorder.none,
                ),
              ),
            ],
        ...
        CreateFormMoveArrows(
            index: widget.index, contentIndex: widget.filler.index),
      ],
    );
  }
}
