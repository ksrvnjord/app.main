...
class FormImageWidget extends ConsumerWidget {
  ...
  Future<Uint8List?> getImageFromUser() async {
    ...
    if (imageData != null) return await imageData.readAsBytes();
    return null;
  }
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ref.watch(currentUserProvider).when(
        data: (user) {
          ...
          final asyncImageString = ref.watch(
            formAnswerImageProvider(
            ...
            child: asyncImageString.when(
              ...
              error: (error, stackTrace) {
                if (error is FirebaseException &&
                  ...
                  return ErrorCardWidget(
                    errorMessage:
                        'Sessie bevat geen aanwezige formreferentie. ',
                  );
                }
              },
            ),
