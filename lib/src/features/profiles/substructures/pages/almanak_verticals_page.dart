...
// TO DO:
// - verticalsPloegenProvider maken
// - verticalsPloegen
// - verticalsCoverPicture
// - verticalsPictureProvider
// - VerticalsDescriptionWidget
// - route

class AlmanakVerticalsPage extends ConsumerWidget {
  const AlmanakVerticalsPage({
    super.key,
    // required this.name,
  });
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // final verticalsPloegen = ref.watch(substructureUsersProvider(name));
...
//       substructureDescriptionProvider(name),
    ...
    return Scaffold(
      ...
      body: Center(child: Text("Verticalennn")),
