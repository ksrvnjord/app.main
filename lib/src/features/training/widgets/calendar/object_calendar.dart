...
import 'package:ksrvnjord_main_app/src/features/training/widgets/calendar/atoms/calendar_background.dart';
import 'package:ksrvnjord_main_app/src/features/training/widgets/calendar/atoms/calendar_reservation.dart';
...
class _ObjectCalendar extends State<ObjectCalendar> {
  ...
  Widget build(BuildContext context) {
    DateTime nowStart = DateTime(now.year, now.month, now.day, 6, 0, 0);
    DateTime nowEnd = DateTime(now.year, now.month, now.day, 22, 0, 0);

    // Get all reservations
    final _reservations = reservationRef
